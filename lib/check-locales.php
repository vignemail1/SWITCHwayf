...
HEADER;
    ...
    foreach ($langStrings['en'] as $k => $v) {
        echo "<dt style='font-weight: bold; color: purple;'>String: " . $k . "</dt>\n<dd>\n";
...
FOOTER;
    ...
    foreach (array_keys($langStrings) as $lang) {
        ...
        foreach ($langStrings['en'] as $k => $v) {
            ...
            } elseif (substr_count($langStrings['en'][$k], '%s') != substr_count($langStrings[$lang][$k], '%s')) {
