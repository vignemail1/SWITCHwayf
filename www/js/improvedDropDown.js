/* ImprovedDropDown */
/* Version 1.0.2 + variable protection */
...
(function(global, factory) {
    ...
    var debugMode = 0; //setting this to 1 will suppress hiding the original select controls for debugging purposes.
        ...
        $.fn.improveDropDown = function(value) {
            ...
            if (arguments.length === 0 || typeof value === 'object') {
                ...
                if (arguments.length === 1) {
                    ...
                    if ('enableValueMatching' in value) {
                        enableValueMatching = value.enableValueMatching;
                    }
                }
                ...
                this.each(function() {
                    ...
                    if (listControl != null) {
                        ...
                        if (item != null) {
                            selectItem(item, true, true, false);
                        }
                    }
                });
            }
    ...
    function getTextElement(sourceElement, imgElement) {
                ...
                case KEY_ENTER:
                    {
                        ...
                        e.stopPropagation();
                        return false; //prevents form submit on enter key when focus is on this field.
                    }
        ...
        newTextElement.keyup(function(e) {
            ...
            switch (e.which) {
                ...
                default:
                    delayCall('updatefilter_' + this.id, function() {
                        updateListFilter(thisTextElement);
                    }, KEY_PRESS_FILTER_DELAY_MS);
            }
        });
        ...
        // Restore text area on focus out
    ...
    function populateListGroupItem(newListControl, optionGroupItem) {
        ...
        optionGroupItem.children('OPTION').each(function() {
            populateListItem(newListControl, jq(this));
        });
    }
    ...
    function getBestMatch(value, listControl) {
        ...
        var filterMatches = listControl.find('.idd_listItem').filter(function() {
            if (doesListItemMach(jq(this), value)) {
                return true;
            }
            return false;
        });
    ...
    function getSelectControlFromOtherControl(Control) {
        return swapControlSuffix(Control, '');
    }
