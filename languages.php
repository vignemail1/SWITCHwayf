...
$langStrings['en']['permanent_cookie_notice'] = 'Setting a default organisation has the effect that you don\'t need to select it anymore when accessing certain services that require login with this web browser. The default setting is:';
...
$langStrings['de']['permanent_cookie_notice'] = 'Wenn Sie die folgende Organisation als Standardeinstellung speichern, werden Sie jedes Mal automatisch zu deren Login Seite weitergeleitet, wenn Sie auf gewisse Dienste zugreifen, welche eine Anmeldung ben&ouml;tigen. Die Einstellung lautet momentan:';
...
$langStrings['fr']['permanent_cookie_notice'] = 'En choisissant un &eacute;tablissement par d&eacute;faut, vous ne devez plus s&eacute;lectionner votre &eacute;tablissement dans la liste lorsque vous acc&eacute;dez &agrave; une ressource avec ce navigateur. D&eacute;faut : ';
...
$langStrings['it']['permanent_cookie_notice'] = 'Se sceglie di impostare una organizzazione predefinita, la sua scelta verr&agrave; ricordata e non dovr&agrave; pi&ugrave; preoccuparsene quando acceder&agrave; a risorse con questo web browser. L\'impostazione predefinita &egrave;:';
