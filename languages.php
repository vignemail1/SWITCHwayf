...
$langStrings['en']['permanent_cookie'] = 'On this page you can set a <strong>default organisation</strong> for this web browser. Setting a default organisation will henceforth redirect you directly to your organisation when you access AAI services. Don\'t use this feature if you use several AAI accounts.';
$langStrings['en']['permanent_cookie_notice'] = 'A default setting for your organisation has the effect that you don\'t need to select it anymore when accessing AAI services with this web browser. The default setting is:';
$langStrings['en']['permanent_cookie_note'] = 'You can reset the default setting by going to: %s';
...
$langStrings['en']['confirm_permanent_selection'] = 'Are you sure that you want to set the selected entry as your default organisation? Don\'t proceed if you have user accounts at multiple organisations.';
...
$langStrings['de']['permanent_cookie'] = 'Auf dieser Seite k&ouml;nnen Sie die <strong>Standardeinstellung Ihrer Organisation</strong> f&uuml;r diesen Webbrowser dauerhaft zu speichern. Sie werden darauf beim Zugriff auf AAI Dienste jedes Mal direkt zur Loginseite Ihrer Organisation weitergeleitet. Dies wird jedoch nicht empfohlen wenn sie mehrere AAI Benutzerkonnten verwenden.';
$langStrings['de']['permanent_cookie_notice'] = 'Wenn Sie die folgende Organisation als Standardeinstellung speichern, werden Sie jedes Mal automatisch zu deren Login Seite weitergeleitet, wenn Sie auf AAI Dienste zugreifen. Die Einstellung lautet momentan:';
$langStrings['de']['permanent_cookie_note'] = 'Sie k&ouml;nnen die Organisation Einstellung zur&uuml;cksetzen auf der Seite: %s';
...
$langStrings['de']['confirm_permanent_selection'] = 'Sind Sie sicher, dass Sie die gew&auml;hlte Organisation als Standard speichern wollen? Dies ist nicht empfehlenswert, wenn Sie Benutzerkonten bei mehreren Organisationen besitzen.';
...
$langStrings['fr']['permanent_cookie'] = 'Sur cette page vous pouvez d&eacute;finir un <strong>&eacute;tablissement par d&eacute;faut</strong> pour ce navigateur. En d&eacute;finissant un &eacute;tablissement par d&eacute;faut, vous serez automatiquement redirig&eacute; vers cet &eacute;tablissement lorsque vous acc&eacute;dez &agrave; une ressource AAI. N\'utilisez pas cette fonction si vous avez plusieurs identit&eacute;s AAI.';
$langStrings['fr']['permanent_cookie_notice'] = 'En choisissant un &eacute;tablissement par d&eacute;faut, vous ne devez plus s&eacute;lectionner votre &eacute;tablissement dans la liste lorsque vous acc&eacute;dez &agrave; une ressource AAI avec ce navigateur. D&eacute;faut : ';
...
$langStrings['it']['permanent_cookie_notice'] = 'Se sceglie di impostare una organizzazione predefinita, la sua scelta verr&agrave; ricordata e non dovr&agrave; pi&ugrave; preoccuparsene quando acceder&agrave; a risorse AAI con questo web browser. L\'impostazione predefinita &egrave;:';
...
$langStrings['it']['confirm_permanent_selection'] = 'E\' sicuro di voler impostare l\'organizzazione selezionata come sua organizzazione predefinita? Non &egrave; da impostare se usa regolarmente diversi account AAI.';
...
$langStrings['pt']['permanent_cookie'] = 'Nesta p&aacute;gina poder&aacute; definir a sua <strong>institui&ccedil;&atilde;o</strong> para este web browser. Defenir uma institui&ccedil;&atilde;o levar&aacute; a que seja redireccionado directamente para a sua institui&ccedil;&atilde;o aquando do acesso de recursos-AAI. N&atilde;o use esta funcionalidade se possuir v&aacute;rias contas de AAI.';
$langStrings['pt']['permanent_cookie_notice'] = 'Por omiss&atilde;o a configura&ccedil;&atilde;o da sua institui&ccedil;&atilde;o ter&acute; a funcionalidade de n&atilde;o ser necess&acute;rio seleccionar novamente recursos federados. A configura&ccedil;&atilde;o &ecute;:';
...
$langStrings['pt']['confirm_permanent_selection'] = 'Tem a certeza que pretende seleccionar a op&ccedil;&atilde;o escolhida como a sua institui&ccedil;&atilde;o? N&atilde;o seleccione se possui v&aacute;rias contas AAI.';
...
$langStrings['jp']['permanent_cookie_notice'] = 'デフォルトの所属機関を選択することで，このブラウザで他のサービスにアクセスした場合に，IdPの選択画面をスキップすることができます．<br>現在セット中のデフォルト所属機関は:';
